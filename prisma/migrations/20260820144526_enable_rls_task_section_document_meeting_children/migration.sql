-- Multi-tenant Phase 3, lot 7 (2026-08-20) — memes principes que les
...
ALTER TABLE "SectionComment" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "MeetingExternalParticipant" ENABLE ROW LEVEL SECURITY;

CREATE POLICY tenant_isolation ON "SectionComment"
...
CREATE POLICY tenant_isolation ON "MeetingDecision"
  USING ("organizationId" = current_setting('app.current_org_id', true))
  WITH CHECK ("organizationId" = current_setting('app.current_org_id', true));

CREATE POLICY tenant_isolation ON "MeetingExternalParticipant"
  USING ("organizationId" = current_setting('app.current_org_id', true))
  WITH CHECK ("organizationId" = current_setting('app.current_org_id', true));
