...
import { deleteAuditPlanDocument } from "@/actions/audit.actions";
import { Button } from "@/components/ui/button";
import { X } from "lucide-react";

export type AuditPlanDocumentRow = { id: string; nom: string; url: string; uploadedByName: string };

export function AuditDocumentsSection({
  documents,
  canManage,
}: {
