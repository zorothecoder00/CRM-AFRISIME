    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <TaskViewSwitcher activeVue={vue} projetId={projetId} onlyMine={onlyMine} annee={annee} mois={mois} from={from} />
          {/* Depuis Planning personnel, ces raccourcis feraient doublon (et
              perdraient le scope personnel) avec les liens Calendrier/Temps
