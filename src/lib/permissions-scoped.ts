 ...
 * un scope est fourni. Séparé de permissions.ts (qui reste importable sans
 * risque depuis un composant client) car ce fichier touche prisma — et donc
 * `pg`, qui casse le bundle navigateur (require("net")/("tls")) s'il se
 * retrouve importé, même via un import différé, depuis un composant client.
