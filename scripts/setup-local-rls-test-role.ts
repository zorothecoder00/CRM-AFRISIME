...
async function main() {
  ...
  await client.query(
    `GRANT SELECT, INSERT, UPDATE, DELETE ON "User", "Department", "Team", "Project", "Task", "ProjectSection", "Document" TO ${ROLE_NAME}`
  );

  console.log("Droits accordés sur User/Department/Team/Project/Task/ProjectSection/Document.");
  console.log(
